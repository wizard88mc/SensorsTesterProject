 ...
 */
public class BasePositionSeonsorManager extends Activity implements View.OnClickListener, SensorEventListener {
    ...
    public BasePositionSeonsorManager(int sensorID) {
        super();
